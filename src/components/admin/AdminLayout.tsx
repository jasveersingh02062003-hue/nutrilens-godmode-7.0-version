...
import {
  ...
  Activity, IndianRupee, Megaphone, Building2, Database, UserCog, Wallet, ListChecks, Crown, Filter,
} from 'lucide-react';
...
const NAV: NavItem[] = [
  ...
  { to: '/admin/funnel', label: 'Funnel', icon: Filter, end: false, roles: ['owner', 'super_admin', 'admin', 'marketer'] },
