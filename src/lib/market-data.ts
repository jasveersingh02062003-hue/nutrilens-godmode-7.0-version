...
export const MARKET_ITEMS: RawMarketItem[] = [
  ...
  // ─── DALS & LENTILS ───
  { id: 'mk_moong_dal', name: 'Moong Dal', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'dals_lentils', basePrice: 130, unit: 'kg', protein: 24, calories: 347, carbs: 60, fat: 1.2, fiber: 16, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein', 'vegetarian'], micro: { iron: 3.5, calcium: 75, zinc: 2.4, folate: 625 }, healthBenefits: ['Very high folate (625mcg) — 156% daily need', 'Easiest dal to digest — ideal for recovery meals', 'High protein + low fat = best veg PES'] },
  { id: 'mk_toor_dal', name: 'Toor Dal (Arhar)', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'dals_lentils', basePrice: 140, unit: 'kg', protein: 22, calories: 343, carbs: 63, fat: 1.5, fiber: 15, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein', 'staple'], micro: { iron: 5.0, calcium: 73, zinc: 2.8, folate: 456 }, healthBenefits: ['India\'s most consumed dal — staple protein source', 'High iron (5mg) for vegetarians', 'Good source of potassium for heart health'] },
  { id: 'mk_masoor_dal', name: 'Masoor Dal', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'dals_lentils', basePrice: 110, unit: 'kg', protein: 25, calories: 352, carbs: 60, fat: 1, fiber: 11, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein', 'budget'], micro: { iron: 7.5, calcium: 56, zinc: 3.3, folate: 479 }, healthBenefits: ['Highest iron among dals (7.5mg)', 'Budget-friendly — best protein per rupee in dals', 'Cooks fastest among all dals (15 min)'] },
  { id: 'mk_chana_dal', name: 'Chana Dal', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'dals_lentils', basePrice: 100, unit: 'kg', protein: 21, calories: 360, carbs: 64, fat: 5, fiber: 11, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein', 'budget'], micro: { iron: 5.3, calcium: 57, zinc: 3.4, folate: 557 } },
  { id: 'mk_urad_dal', name: 'Black Urad Dal', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'dals_lentils', basePrice: 120, unit: 'kg', protein: 25, calories: 347, carbs: 59, fat: 1.4, fiber: 18, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein'], micro: { iron: 7.6, calcium: 154, zinc: 2.0, folate: 216 }, healthBenefits: ['Exceptional calcium (154mg) for a dal', 'Very high iron (7.6mg)', 'High fiber (18g) for gut health'] },

  // ─── LEGUMES ───
  { id: 'mk_rajma', name: 'Rajma (Kidney Beans)', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'legumes', basePrice: 120, unit: 'kg', protein: 24, calories: 333, carbs: 60, fat: 0.8, fiber: 15, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein'], micro: { iron: 6.7, calcium: 143, zinc: 2.8, folate: 394 } },
  { id: 'mk_chole', name: 'Chole (Chickpeas)', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'legumes', basePrice: 90, unit: 'kg', protein: 19, calories: 364, carbs: 61, fat: 6, fiber: 17, servingDesc: 'per 100g (raw)', isVeg: true, tags: ['high_protein', 'budget'], micro: { iron: 6.2, calcium: 105, zinc: 3.4, folate: 557 } },
  { id: 'mk_soya_chunks', name: 'Soya Chunks', emoji: '🫘', topCategory: 'dals_pulses', subcategory: 'legumes', basePrice: 85, unit: '200g', protein: 52, calories: 336, carbs: 33, fat: 0.5, fiber: 13, servingDesc: 'per 100g (dry)', isVeg: true, tags: ['high_protein', 'budget', 'best_value'], micro: { iron: 20, calcium: 350, zinc: 4.9, folate: 165 }, healthBenefits: ['52g protein per 100g — rivals whey protein', 'Very high iron (20mg) and calcium (350mg)', 'Most affordable protein source in India (₹85/200g)'], cookingTips: ['Soak in hot water for 15 min, squeeze out water', 'Add to curries, pulao, or stir-fry', 'Combine with rice for complete amino acid profile'] },
