...
export const INDIAN_FOODS: IndianFood[] = [
  ...
  { id: 'in058', name: 'Prawn Masala', hindi: 'झींगा मसाला', category: 'Non-Veg', calories: 145, protein: 18.0, carbs: 5, fat: 6.0, fiber: 1.0, iron: 2.5, calcium: 75, vitC: 5, defaultServing: 150, servingUnit: 'bowl', allergens: ['shellfish'] },
  ...
  { id: 'in05d', name: 'Chicken Saagwala', hindi: 'चिकन साग', category: 'Non-Veg', calories: 165, protein: 17.0, carbs: 6, fat: 8.5, fiber: 2.5, iron: 3.5, calcium: 80, vitC: 12, defaultServing: 150, servingUnit: 'bowl', allergens: ['dairy'] },
  ...
  { id: 'in05j', name: 'Chicken Malai Tikka', hindi: 'चिकन मलाई टिक्का', category: 'Non-Veg', calories: 180, protein: 22.0, carbs: 4, fat: 9.0, fiber: 0.3, iron: 1.8, calcium: 40, vitC: 2, defaultServing: 120, servingUnit: 'serving', allergens: ['dairy', 'nuts'] },
  ...
  { id: 'in05l', name: 'Chicken Nihari', hindi: 'चिकन निहारी', category: 'Non-Veg', calories: 190, protein: 16.0, carbs: 8, fat: 11.0, fiber: 1.0, iron: 2.5, calcium: 25, vitC: 3, defaultServing: 200, servingUnit: 'bowl', allergens: ['gluten'] },
  { id: 'in05m', name: 'Fish Fry', hindi: 'मछली फ्राई', category: 'Non-Veg', calories: 210, protein: 18.0, carbs: 8, fat: 12.5, fiber: 0.5, iron: 1.5, calcium: 30, vitC: 2, defaultServing: 100, servingUnit: 'piece', allergens: ['fish'] },
  { id: 'in05n', name: 'Fish Tikka', hindi: 'फिश टिक्का', category: 'Non-Veg', calories: 145, protein: 20.0, carbs: 4, fat: 5.5, fiber: 0.3, iron: 1.2, calcium: 25, vitC: 3, defaultServing: 100, servingUnit: 'piece', allergens: ['fish'] },
  { id: 'in05o', name: 'Pomfret Fry', hindi: 'पोम्फ्रेट फ्राई', category: 'Non-Veg', calories: 195, protein: 20.0, carbs: 6, fat: 10.5, fiber: 0.3, iron: 1.5, calcium: 30, vitC: 2, defaultServing: 120, servingUnit: 'piece', allergens: ['fish'] },
  { id: 'in05p', name: 'Goan Fish Curry', hindi: 'गोवा फिश करी', category: 'Non-Veg', calories: 155, protein: 16.0, carbs: 6, fat: 8.0, fiber: 1.0, iron: 1.5, calcium: 35, vitC: 5, defaultServing: 150, servingUnit: 'bowl', allergens: ['fish'] },
  { id: 'in05q', name: 'Kerala Fish Molee', hindi: 'केरला फिश मोली', category: 'Non-Veg', calories: 165, protein: 15.0, carbs: 5, fat: 10.0, fiber: 1.0, iron: 1.2, calcium: 30, vitC: 3, defaultServing: 150, servingUnit: 'bowl', allergens: ['fish'] },
  { id: 'in05r', name: 'Prawn Curry', hindi: 'झींगा करी', category: 'Non-Veg', calories: 140, protein: 17.0, carbs: 5, fat: 6.0, fiber: 0.8, iron: 2.0, calcium: 70, vitC: 4, defaultServing: 150, servingUnit: 'bowl', allergens: ['shellfish'] },
  { id: 'in05s', name: 'Crab Masala', hindi: 'केकड़ा मसाला', category: 'Non-Veg', calories: 130, protein: 15.0, carbs: 5, fat: 6.0, fiber: 0.8, iron: 2.5, calcium: 85, vitC: 4, defaultServing: 150, servingUnit: 'bowl', allergens: ['shellfish'] },
  { id: 'in05t', name: 'Chicken Lollipop', hindi: 'चिकन लॉलीपॉप', category: 'Non-Veg', calories: 250, protein: 15.0, carbs: 12, fat: 16.0, fiber: 0.5, iron: 1.5, calcium: 20, vitC: 3, defaultServing: 80, servingUnit: 'piece', allergens: ['eggs', 'soy', 'gluten'] },
  ...
  { id: 'in05v', name: 'Chicken Wings (tandoori)', hindi: 'तंदूरी विंग्स', category: 'Non-Veg', calories: 190, protein: 20.0, carbs: 3, fat: 11.0, fiber: 0.3, iron: 1.8, calcium: 18, vitC: 2, defaultServing: 100, servingUnit: 'serving', allergens: ['dairy'] },
  ...
  { id: 'in206', name: 'Boiled Egg', hindi: 'उबला अंडा', category: 'Non-Veg', calories: 155, protein: 13.0, carbs: 1.1, fat: 11.0, fiber: 0, iron: 1.2, calcium: 50, vitC: 0, defaultServing: 50, servingUnit: 'piece', allergens: ['eggs'] },
  ...
  { id: 'in098', name: 'Thandai', hindi: 'ठंडाई', category: 'Beverages', calories: 155, protein: 5.0, carbs: 20, fat: 6.5, fiber: 0.5, iron: 0.5, calcium: 120, vitC: 2, defaultServing: 250, servingUnit: 'glass', allergens: ['dairy', 'nuts'] },
  { id: 'in099', name: 'Badam Milk', hindi: 'बादाम दूध', category: 'Beverages', calories: 130, protein: 5.0, carbs: 16, fat: 5.5, fiber: 0.5, iron: 0.5, calcium: 140, vitC: 1, defaultServing: 250, servingUnit: 'glass', allergens: ['dairy', 'nuts'] },
  ...
  { id: 'in134', name: 'Pongal', hindi: 'पोंगल', category: 'South Indian', calories: 140, protein: 5.0, carbs: 22, fat: 3.5, fiber: 2.0, iron: 1.2, calcium: 20, vitC: 1, defaultServing: 200, servingUnit: 'bowl', allergens: ['dairy', 'nuts'] },
  { id: 'in106', name: 'Rava Dosa', hindi: 'रवा डोसा', category: 'South Indian', calories: 185, protein: 4.0, carbs: 26, fat: 7.5, fiber: 1.0, iron: 1.0, calcium: 18, vitC: 2, defaultServing: 100, servingUnit: 'piece', allergens: ['gluten'] },
  ...
  { id: 'in108', name: 'Bisi Bele Bath', hindi: 'बिसि बेले बाथ', category: 'South Indian', calories: 165, protein: 6.0, carbs: 25, fat: 4.5, fiber: 3.0, iron: 2.0, calcium: 35, vitC: 5, defaultServing: 200, servingUnit: 'bowl', allergens: ['peanuts', 'dairy'] },
  ...
  { id: 'in601', name: 'Veg Noodles', hindi: 'वेज नूडल्स', category: 'Fast Food', calories: 170, protein: 4.0, carbs: 28, fat: 5.0, fiber: 2.0, iron: 1.0, calcium: 15, vitC: 5, defaultServing: 250, servingUnit: 'plate', allergens: ['gluten', 'soy'] },
  { id: 'in602', name: 'Chicken Noodles', hindi: 'चिकन नूडल्स', category: 'Fast Food', calories: 185, protein: 10.0, carbs: 26, fat: 5.5, fiber: 1.5, iron: 1.2, calcium: 18, vitC: 3, defaultServing: 250, servingUnit: 'plate', allergens: ['gluten', 'soy'] },
  { id: 'in603', name: 'Manchurian (veg)', hindi: 'वेज मंचूरियन', category: 'Fast Food', calories: 185, protein: 3.5, carbs: 20, fat: 10.0, fiber: 2.0, iron: 1.0, calcium: 25, vitC: 10, defaultServing: 150, servingUnit: 'bowl', allergens: ['soy', 'gluten'] },
  { id: 'in604', name: 'Spring Roll (veg)', hindi: 'स्प्रिंग रोल', category: 'Fast Food', calories: 245, protein: 4.0, carbs: 28, fat: 13.0, fiber: 1.5, iron: 1.0, calcium: 15, vitC: 3, defaultServing: 60, servingUnit: 'piece', allergens: ['gluten', 'soy'] },
  { id: 'in605', name: 'Paneer Chilli', hindi: 'पनीर चिली', category: 'Fast Food', calories: 230, protein: 12.0, carbs: 12, fat: 16.0, fiber: 1.5, iron: 1.5, calcium: 250, vitC: 15, defaultServing: 150, servingUnit: 'bowl', allergens: ['dairy', 'soy', 'gluten'] },
  { id: 'in606', name: 'Schezwan Fried Rice', hindi: 'शेजवान फ्राइड राइस', category: 'Fast Food', calories: 175, protein: 4.0, carbs: 28, fat: 5.5, fiber: 1.5, iron: 1.0, calcium: 12, vitC: 5, defaultServing: 250, servingUnit: 'plate', allergens: ['soy'] },
  { id: 'in607', name: 'Burger (veg)', hindi: 'वेज बर्गर', category: 'Fast Food', calories: 280, protein: 8.0, carbs: 35, fat: 12.0, fiber: 2.5, iron: 2.0, calcium: 30, vitC: 5, defaultServing: 150, servingUnit: 'piece', allergens: ['gluten'] },
  { id: 'in608', name: 'Burger (chicken)', hindi: 'चिकन बर्गर', category: 'Fast Food', calories: 310, protein: 15.0, carbs: 32, fat: 14.0, fiber: 2.0, iron: 2.5, calcium: 25, vitC: 3, defaultServing: 180, servingUnit: 'piece', allergens: ['gluten'] },
  { id: 'in609', name: 'Pizza (veg, 1 slice)', hindi: 'पिज़्ज़ा', category: 'Fast Food', calories: 266, protein: 10.0, carbs: 33, fat: 10.0, fiber: 2.0, iron: 1.5, calcium: 120, vitC: 5, defaultServing: 100, servingUnit: 'slice', allergens: ['gluten', 'dairy'] },
  ...
  { id: 'in60b', name: 'Maggi Noodles (cooked)', hindi: 'मैगी', category: 'Fast Food', calories: 188, protein: 4.5, carbs: 26, fat: 7.5, fiber: 1.0, iron: 2.5, calcium: 15, vitC: 0, defaultServing: 200, servingUnit: 'bowl', allergens: ['gluten'] },
  { id: 'in60c', name: 'Pasta (red sauce)', hindi: 'पास्ता', category: 'Fast Food', calories: 160, protein: 5.5, carbs: 28, fat: 3.5, fiber: 2.0, iron: 1.5, calcium: 20, vitC: 8, defaultServing: 200, servingUnit: 'bowl', allergens: ['gluten'] },
  { id: 'in60d', name: 'Sandwich (veg)', hindi: 'सैंडविच', category: 'Fast Food', calories: 235, protein: 7.0, carbs: 28, fat: 10.0, fiber: 2.5, iron: 1.5, calcium: 50, vitC: 5, defaultServing: 120, servingUnit: 'piece', allergens: ['gluten', 'dairy'] },
  { id: 'in60e', name: 'Grilled Sandwich', hindi: 'ग्रिल्ड सैंडविच', category: 'Fast Food', calories: 270, protein: 8.0, carbs: 28, fat: 14.0, fiber: 2.0, iron: 1.5, calcium: 80, vitC: 5, defaultServing: 130, servingUnit: 'piece', allergens: ['gluten', 'dairy'] },
  { id: 'in60f', name: 'Dahi Vada', hindi: 'दही वड़ा', category: 'Fast Food', calories: 175, protein: 6.0, carbs: 22, fat: 7.0, fiber: 2.5, iron: 1.5, calcium: 70, vitC: 3, defaultServing: 100, servingUnit: 'serving', allergens: ['dairy'] },
