    ...
    <div className="max-w-lg mx-auto min-h-screen bg-background pb-24">
      ...
      <div className="px-4 pt-4 space-y-4">
        ...
        {items.length === 0 ? (
          ...
          >
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-primary/15 to-primary/5 flex items-center justify-center mx-auto mb-4">
              <ClipboardList className="w-10 h-10 text-primary" />
            </div>
            <p className="text-base font-bold text-foreground mb-1.5">Your list is empty</p>
            <p className="text-xs text-muted-foreground max-w-xs mx-auto leading-relaxed mb-5">
              Build your shopping list from market items, type them above, or auto-import from your meal plan
            </p>
            <motion.button
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/market')}
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-semibold"
            >
